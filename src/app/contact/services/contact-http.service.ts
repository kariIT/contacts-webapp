...
export class ContactHttpService {
  ...
  put(contact): Observable<Contact> {
    const headers: HttpHeaders = this.getAuthorizationHeader();
    return this.httpClient.put(this.url + '/' + contact.id, contact, {headers})
      .pipe(map(response => {
        return response as Contact;
      }));
  }
  ...
  post(contact): Observable<Contact> {
    const headers: HttpHeaders = this.getAuthorizationHeader();
    return this.httpClient.post(this.url, contact, {headers})
      .pipe(map(response => {
        return response as Contact;
      }));
  }
  ...
  delete(contact): Observable<any> {
    const headers: HttpHeaders = this.getAuthorizationHeader();
    return this.httpClient.delete(this.url + '/' + contact.id, {headers}).pipe(map(response => {
      return response as Contact;
    }));
  }
